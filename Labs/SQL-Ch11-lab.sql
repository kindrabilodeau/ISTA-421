...
SET NOCOUNT ON; --supresses messages 
USE TSQLV4;
...
DECLARE @i AS INT;--@is a variable 
SET @i = 10;
GO --Seperates the batches (batch is a group of statements)
...
DECLARE @empname AS NVARCHAR(61); --sets variable as a unicode 61 is the number of characters 
